...
static int ji1, ji2;
static int ki1, ki2;
static float dxi, deta, dzeta;
static float tx1, tx2, tx3;
static float ty1, ty2, ty3;
static float tz1, tz2, tz3;
...
/* common /cvar/ */
static float u[ISIZ1][ISIZ2/2*2+1][ISIZ3/2*2+1][5];
static float rsd[ISIZ1][ISIZ2/2*2+1][ISIZ3/2*2+1][5];
static float frct[ISIZ1][ISIZ2/2*2+1][ISIZ3/2*2+1][5];
static float flux[ISIZ1][ISIZ2/2*2+1][ISIZ3/2*2+1][5];
...
static float dt, omega, tolrsd[5], rsdnm[5], frc, ttotal;
static __float128 errnm[5];
  
/* common /cjac/ */
static float a[ISIZ1][ISIZ2][5][5];
static float b[ISIZ1][ISIZ2][5][5];
static float c[ISIZ1][ISIZ2][5][5];
static float d[ISIZ1][ISIZ2][5][5];
