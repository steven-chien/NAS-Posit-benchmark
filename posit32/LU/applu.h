...
static int ji1, ji2;
static int ki1, ki2;
static posit32 dxi, deta, dzeta;
static posit32 tx1, tx2, tx3;
static posit32 ty1, ty2, ty3;
static posit32 tz1, tz2, tz3;
...
/* common /cvar/ */
static posit32 u[ISIZ1][ISIZ2/2*2+1][ISIZ3/2*2+1][5];
static posit32 rsd[ISIZ1][ISIZ2/2*2+1][ISIZ3/2*2+1][5];
static posit32 frct[ISIZ1][ISIZ2/2*2+1][ISIZ3/2*2+1][5];
static posit32 flux[ISIZ1][ISIZ2/2*2+1][ISIZ3/2*2+1][5];
...
static posit32 dt, omega, tolrsd[5], rsdnm[5], frc, ttotal;
static __float128 errnm[5];
  
/* common /cjac/ */
static posit32 a[ISIZ1][ISIZ2][5][5];
static posit32 b[ISIZ1][ISIZ2][5][5];
static posit32 c[ISIZ1][ISIZ2][5][5];
static posit32 d[ISIZ1][ISIZ2][5][5];
