...
static void blts (int nx, int ny, int nz, int k,
		posit32 omega,
		posit32 v[ISIZ1][ISIZ2/2*2+1][ISIZ3/2*2+1][5],
		posit32 ldz[ISIZ1][ISIZ2][5][5],
		posit32 ldy[ISIZ1][ISIZ2][5][5],
		posit32 ldx[ISIZ1][ISIZ2][5][5],
		posit32 d[ISIZ1][ISIZ2][5][5],
		int ist, int iend, int jst, int jend,
		int nx0, int ny0 );
static void buts(int nx, int ny, int nz, int k,
		posit32 omega,
		posit32 v[ISIZ1][ISIZ2/2*2+1][ISIZ3/2*2+1][5],
		posit32 tv[ISIZ1][ISIZ2][5],
		posit32 d[ISIZ1][ISIZ2][5][5],
		posit32 udx[ISIZ1][ISIZ2][5][5],
		posit32 udy[ISIZ1][ISIZ2][5][5],
		posit32 udz[ISIZ1][ISIZ2][5][5],
		int ist, int iend, int jst, int jend,
		int nx0, int ny0 );
static void domain(void);
static void erhs(void);
static void error(void);
static void exact( int i, int j, int k, posit32 u000ijk[5] );
...
static void verify(posit32 xcr[5], __float128 xce[5], posit32 xci,
...
static void erhs(void) {
	...
	posit32  u21, u31, u41;
	posit32  tmp;
	posit32  u21i, u31i, u41i, u51i;
	posit32  u21j, u31j, u41j, u51j;
	posit32  u21k, u31k, u41k, u51k;
	posit32  u21im1, u31im1, u41im1, u51im1;
	posit32  u21jm1, u31jm1, u41jm1, u51jm1;
	posit32  u21km1, u31km1, u41km1, u51km1;
...
static void l2norm (int nx0, int ny0, int nz0,
	...
	/*--------------------------------------------------------------------
	  ...
	  --------------------------------------------------------------------*/
	int i, j, k, m;
	posit32 sum0=0.0, sum1=0.0, sum2=0.0, sum3=0.0, sum4=0.0;
...
static void pintgr(void) {
	...
	posit32 phi1[ISIZ2+2][ISIZ3+2];	/* phi1(0:isiz2+1,0:isiz3+1) */
	posit32 phi2[ISIZ2+2][ISIZ3+2];	/* phi2(0:isiz2+1,0:isiz3+1) */
	posit32  frc1, frc2, frc3;
...
static void setiv(void) {
	...
	int iglob, jglob;
	posit32  xi, eta, zeta;
	posit32  pxi, peta, pzeta;
	posit32  ue_1jk[5],ue_nx0jk[5],ue_i1k[5],
...
static void ssor(void) {
	...
	int istep;
	posit32  tmp;
	posit32  delunm[5], tv[ISIZ1][ISIZ2][5];
