...
/* COMMON block: excomm */
static __float128 ex[EXPMAX+1];	/* ex(0:expmax) */
...
/* COMMON block: ucomm */
static qcomplex u[NX];

/* for checksum data */

/* COMMON block: sumcomm */
static qcomplex sums[NITER_DEFAULT+1]; /* sums(0:niter_default) */
...
static char real_str[128];
static char imag_str[128];
